...
const procIcon = computed(() => {
  ...
  return `${baseUrl}assets/${folder}/${icon}.svg`;
});

const osLogo = computed(() => `${baseUrl}assets/ui/windows-11.svg`);
  ...
  <div class="specs-column">
    <div class="specs-grid">
      ...
      <SpecCard 
        ...
        :tag="specs.ramType"
        :value="specs.ram"
        :icon="`${baseUrl}assets/ui/ram.svg`"
      />
      ...
      <SpecCard 
        ...
        :value="specs.storage"
        :icon="`${baseUrl}assets/ui/storage.svg`"
      />
      ...
      <SpecCard 
        ...
        label="Pantalla"
        :value="specs.display"
        :icon="`${baseUrl}assets/ui/screen.svg`"
      />
      ...
      <SpecCard 
        ...
        label="Gráficos"
        :value="specs.gpu"
        :icon="`${baseUrl}assets/ui/gpu.svg`"
      />
